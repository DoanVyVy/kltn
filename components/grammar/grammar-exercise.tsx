...
export function GrammarExercise({
  ...
  const handleSubmit = () => {
    ...
    switch (exercise.type) {
      ...
      case "reorder":
        correct =
          JSON.stringify(userReorderAnswer) === JSON.stringify(exercise.answer);
        break;
    }
  ...
  useEffect(() => {
    if (
      ...
      const shuffled = [...exercise.answer].sort(() => Math.random() - 0.5);
                ...
                >
                  ...
                  <div className="flex gap-1">
                    ...
                    <Button
                      ...
                      disabled={index === userReorderAnswer.length - 1}
                      className="h-8 w-8 p-0"
                    >
                      ↓
                    </Button>
        ...
        return (
          <RadioGroup value={userAnswer} onValueChange={setUserAnswer}>
            <div className="flex items-center space-x-2 rounded-md p-2 hover:bg-gray-50">
              ...
              <Label htmlFor="option-true" className="w-full cursor-pointer">
                Đúng
              </Label>
            </div>
            <div className="flex items-center space-x-2 rounded-md p-2 hover:bg-gray-50">
              <RadioGroupItem value="false" id="option-false" />
              <Label htmlFor="option-false" className="w-full cursor-pointer">
                Sai
              </Label>
            </div>
          </RadioGroup>
          ...
          <Button
            ...
            disabled={
              ...
              (exercise.type !== "fillBlank" &&
                !userAnswer &&
                exercise.type !== "reorder") ||
              (exercise.type === "reorder" && userReorderAnswer.length === 0)
            }
          >
            Kiểm tra
          </Button>
